...
@ExperimentalTime
class SystemSortingTestFragment : Fragment() {
    ...
    private fun setupToolbar() {
        activity?.title = getString(R.string.system_sorting_test_screen_title)
    }
    ...
    private fun doMeasure(): String {
        ...
        repeat(ITERATIONS_COUNT) {
            ...
            times.add(measureTime { items.sortWith(compareBy { it.number }) }.inSeconds)
        }
