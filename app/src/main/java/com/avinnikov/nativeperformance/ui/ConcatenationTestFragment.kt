...
@ExperimentalTime
class ConcatenationTestFragment : Fragment() {
    ...
    private fun setupToolbar() {
        activity?.title = getString(R.string.concatenation_test_screen_title)
    }

    private fun doMeasure(): String {
        val times = mutableListOf<Double>()
        val string = getString(R.string.huge_text)
        val plusString = getString(R.string.huge_text)
        ...
        return getString(R.string.concatenation_time).format(times.average())
    }
}